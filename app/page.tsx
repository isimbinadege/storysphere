...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-900">
      ...
      {/* MAIN CONTENT — PERFECT SPACING & RESPONSIVE */}
        ...
        {stories.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            {stories.map((story) => (
              ...
              >
                {/* Image placeholder */}
                <div className="h-56 bg-gradient-to-br from-stone-200 to-stone-300 border-b border-stone-200" />
                ...
                <div className="p-8">
                  ...
                  <p className="mt-6 text-xs text-stone-500 uppercase tracking-wider">
